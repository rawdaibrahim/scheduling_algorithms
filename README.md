...
output with quantum time 3: ![My Image](RR.png)

## Shortest-Job-First
SJF is a non-preemptive scheduling that selects the waiting process with the smallest execution time to execute next. 
In this implementation <a href="https://github.com/rawdaibrahim/scheduling_algorithms/blob/main/SJF/SJF.java">SJF.java</a> i use a priority queue data structure which selects process with the smalest burst time . output:
![My Image](SJF.png)
